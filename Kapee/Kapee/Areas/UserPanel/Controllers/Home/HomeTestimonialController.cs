...
namespace Kapee.Areas.UserPanel.Controllers.Home
{
    ...
    public class HomeTestimonialController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([Bind("FullName,Upload,Photo,Id,Position,Content,Star")] Testimonial testimonial)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Edit(int id, [Bind("FullName,Upload,Photo,Id,Position,Content,Star")] Testimonial testimonial)
        {
        ...
        {
            return _context.Testimonials.Any(x => x.Id == id);
        }
    }
}
